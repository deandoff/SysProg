...
public class Converter {
    ...
    public static String convertToBinaryCodeSTART(String address, String command, String OP1) {
        int op1Value = Integer.parseInt(OP1.trim(), 16); // читаем HEX, убираем пробелы
        return "H" + " " + address + " " + "000000" + " " + convertToSixChars(convertDecToHex(op1Value));
    }
